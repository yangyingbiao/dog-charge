...
create table `user`(
    ...
    `amount` DECIMAL(6, 2) NOT NULL DEFAULT 0 COMMENT '',
    `reward_amount` DECIMAL(6, 2) NOT NULL DEFAULT 0 COMMENT '',
...
`merchant_id` MEDIUMINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '商户ID',
`station_id` MEDIUMINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '站点ID',
`unit_price` DECIMAL(4, 2) NOT NULL DEFAULT 0 COMMENT '单价多少钱（小时）',
`min_settle_quantity` TINYINT NOT NULL DEFAULT 0 COMMENT '最小结算数量',
